...
public class ContaAcesso {
    ...
    /**
     * Valida a senha informada. Se errada, incrementa tentativas.
     * Bloqueia a conta ao atingir o máximo de tentativas.
     *
     * @param senhaTentativa Senha digitada pelo usuário
     * @return true se a senha estiver correta e a conta não estiver bloqueada
     */
